            ...
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <p className="mb-8 leading-relaxed">
                        ...
                        프로젝트의 완성도를 높이는 것에 집착합니다. 그로 인해 프로젝트 마무리 과정에
                        오랜 시간을 할애하는 편이지만, 원하는 결과물을 얻는 것에 큰 기쁨을 느끼기
                        때문에 그 시간을 즐깁니다.
                        <br />
                        <br />
                        새로운 기술을 접하는 것이 프론트엔드 개발자로서 큰 성장을 도모한다고 믿고
                        있기에 이에 거리낌이 없고, 매 프로젝트에 다른 기술을 적용하려고
                        노력하였습니다.
                        <br />
                        <br />
                        정보를 전달하거나 의견이 맞지 않는 상황에서 상대방을 배려하는 커뮤니케이션에
                        능합니다. 협업 시 그러한 문제 상황을 좋은 분위기로 이끌어 원하는 결과물을
                        얻은 다수의 경험이 있습니다.
                    </p>
