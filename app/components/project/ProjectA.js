...
export default function ProjectA() {
    const details = [
        ...
        '운동 데이터 CRUD를 위한 데이터베이스로 Realtime Database와 Cloud Firestore를 고민하였습니다. 깊이있는 데이터를 저장하면서 하위 값은 반환받을 필요가 없었기 때문에 문서 컬렉션 데이터 형식을 가지는 Cloud Firestore를 선택하였습니다.',
