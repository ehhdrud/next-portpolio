...
export default function ProjectA() {
    const details = [
        'Next.js의 SSR 방식을 통해 초기 로딩 속도와 검색 엔진 최적화 문제 해결하고, 함수 호출을 통한 Lazy Loading과 메모이제이션 기술을 적용하여 렌더링 성능을 추가 개선하였습니다. (PageSpeeds Insights의 성능 점수 80~90점대에서 100점으로 향상.)',
